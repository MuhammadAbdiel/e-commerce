...
<div class="row mb-5">
    <div class="col-md-12">
        <form action="/dashboard/category/{{ $category->category_code }}" method="post">
            @method('put')
            @csrf
            <div class="mb-3">
                <label for="category_code" class="form-label">Category Code</label>
                <input type="text" readonly class="form-control @error('category_code') is-invalid @enderror"
            ...
            <button type="submit" class="btn btn-success"><span data-feather="save"></span> Update</button>
        </form>
    </div>
</div>
@endsection